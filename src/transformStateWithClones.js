...
function transformStateWithClones(state, transforms) {
  ...
  for (const transformation of transforms) {
    ...
    transformedStates.push({ ...stateTransformed });
  }
